...
mkdir -p "${REPO_ROOT}/output/rgb" "${REPO_ROOT}/output/thermal" "${REPO_ROOT}/output/radiometric"

echo "Configured worlds/thermalRandy.sdf for: ${REPO_ROOT}"
echo "Output will be written to: ${REPO_ROOT}/output/{rgb,thermal,radiometric}"
